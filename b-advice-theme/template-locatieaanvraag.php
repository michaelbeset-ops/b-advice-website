...
.form-success { display:none; background:rgba(76,175,114,.08); border:1.5px solid rgba(76,175,114,.25); border-radius:10px; padding:32px; text-align:center; }
...
.form-success-text { font-size:15px; color:var(--ink-3); line-height:1.6; }
@media(max-width:768px) { .loc-layout { grid-template-columns:1fr !important; padding:32px 20px 64px !important; } .loc-sidebar { position:static; } .form-row-3 { grid-template-columns:1fr 1fr !important; } }
</style>
<?php });
